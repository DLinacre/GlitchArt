...
import { Sparkles, FolderTree, Palette, Code, Github, Download } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-gray-950/90 backdrop-blur-md border-b border-gray-800 text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between py-3 gap-4">
          ...
          {/* Desktop Profile Switcher & ZIP Action */}
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-mono font-bold bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-gray-950 shadow-lg shadow-cyan-500/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
            >
              <Download className="w-3.5 h-3.5 stroke-[2.5]" />
              <span>EXPORT 🎨_FOLDER.ZIP</span>
            </button>
          </div>
